module github.com/agntcy/oasf-sdk/translation
...
require (
	...
	buf.build/gen/go/agntcy/oasf/protocolbuffers/go v1.36.8-00000000000000-bda8dba52bd5.1
	github.com/agntcy/oasf-sdk/core v0.0.0
