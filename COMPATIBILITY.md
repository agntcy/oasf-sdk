...
| OASF-SDK           | OASF v1alpha1<br>(0.7.0) | OASF v1alpha2<br>(0.8.0) |
| ------------------ | ------------------------ | ------------------------ |
| DecodingService    | ✅                       | ✅                       |
| TranslationService | ✅                       | ✅                       |
| ValidationService  | ✅                       | ✅                       |
...
| OASF-SDK           | OASF v1alpha1<br>(0.7.0) | OASF v1alpha2<br>(0.8.0) | Notes                                      |
| ------------------ | ------------------------ | ------------------------ | ------------------------------------------ |
| DecodingService    | N/A                      | N/A                      | Outputs typed protobuf, not OASF records   |
| TranslationService | ❌                       | ✅                       | `*ToRecord` methods generate 0.8.0 only    |
| ValidationService  | N/A                      | N/A                      | Validation only, no record generation      |
