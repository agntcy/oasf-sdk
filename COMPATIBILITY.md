...
| OASF-SDK           | OASF v1alpha1<br>(0.7.0) | OASF v1alpha2<br>(0.8.0) | OASF v1<br>(1.0.0-rc.1) |
| ------------------ | ------------------------ | ------------------------ | ------------------ |
| DecodingService    | ✅                       | ✅                       | ✅                 |
| TranslationService | ✅                       | ✅                       | ❌                 |
| ValidationService  | ✅                       | ✅                       | ✅                 |
...
| OASF-SDK           | OASF v1alpha1<br>(0.7.0) | OASF v1alpha2<br>(0.8.0) | OASF v1<br>(1.0.0-rc.1) | Notes                                      |
| ------------------ | ------------------------ | ------------------------ | ------------------ | ------------------------------------------ |
